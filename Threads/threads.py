...
class Thread():
    ...
    def connect_robot_thread(self):
        if app.ready == True:
            ...
            self.robot_filler.info_message.connect(app.window_filler.info_message)

            self.robot_filler.pump_station.info_message.connect(app.window_filler.info_message)
